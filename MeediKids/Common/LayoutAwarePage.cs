...
namespace MeediKids.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        #region Display-Auto-Rotation

        private bool _isAutoRotationOverridden;
        private DisplayOrientations _oldAutoRotationPreferences;

        /// <summary>
        ///     Deaktiviert die Display-Auto-Rotation.
        ///     Die App untersützt bis zum Aufruf von <see cref="RestoreDisplayAutoRotation" /> nur noch den Landscape-Modus.
        /// </summary>
        public void DisableDisplayAutoRotation()
        {
            OverrideDisplayAutoRotation(DisplayOrientations.Landscape);
        }

        /// <summary>
        ///     Überschreibt die aktuelle Einstellung der Display-Auto-Rotation.
        ///     In der Regel ist dies die Voreinstellung aus dem App-Manifest.
        ///     <see cref="RestoreDisplayAutoRotation" /> aufrufen, um das Überschreiben rückgängig zu machen.
        /// </summary>
        /// <param name="newDisplayOrientations"></param>
        public void OverrideDisplayAutoRotation(DisplayOrientations newDisplayOrientations)
        {
            if (!_isAutoRotationOverridden)
            {
                // Beim ersten Aufruf die Voreinstellung für RestoreDisplayAutoRotation speichern.
                _oldAutoRotationPreferences = DisplayProperties.AutoRotationPreferences;
            }

            _isAutoRotationOverridden = true;
            DisplayProperties.AutoRotationPreferences = newDisplayOrientations;
        }

        /// <summary>
        ///     Macht <see cref="DisableDisplayAutoRotation" /> oder <see cref="OverrideDisplayAutoRotation" /> rückgängig.
        /// </summary>
        public void RestoreDisplayAutoRotation()
        {
            if (!_isAutoRotationOverridden)
            {
                return;
            ...
            _isAutoRotationOverridden = false;
            DisplayProperties.AutoRotationPreferences = _oldAutoRotationPreferences;
        }
